...
| Utilizador técnico dedicado                    | Em uso está a conta pessoal. Só falta a conta: o âmbito já está decidido — todos os núcleos. A conta nova tem de nascer com o `company_ids` completo, ou passa a haver núcleos que nenhuma app lê                                                                                                                                                                                       |
...
| Domínio de produção                            | `myrefood.pt` fica como staging permanente; o endereço definitivo continua por decidir e depende de terceiros                                                                                                                                                                                                                                                                           |
